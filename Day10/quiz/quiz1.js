...
<div class ="box">
     <img src = "${x.image}" alt="" />
      <div class ="info">
     <span class = "name"> ${x.firstName + "" + x.lastName + "" + x.firstName} </span>
     <span class = "born"> ${x.birthDate.replaceAll( "-", "/")} </span>
<span class ="job">  ${x.company.department} </span>
<span class ="email">  ${x.email} </span>
</div>
</div>`
       ...
       data.users.forEach((x) =>  {
        boxs.insertAdjacentHTML("beforeend",Tag(x)); 
